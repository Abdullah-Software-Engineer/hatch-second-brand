...
export default function ConversionFocusedWebDesignContent({ post }: BlogContentProps) {
  return (
    <article className="prose prose-gray max-w-3xl text-left">
      <p className="text-[#555] text-[17px] leading-[1.6] mb-4">
      ...
      <p className="text-[#555] text-[17px] leading-[1.6] mb-8">
      ...
      <p className="text-[#3C3C3C] text-[17px] leading-relaxed mb-2 font-medium">Smart Asset Loading</p>
      <p className="text-[#3C3C3C] text-[17px] leading-relaxed mb-4">
      ...
      <p className="text-[#3C3C3C] text-[17px] leading-relaxed mb-2 font-medium">Verbose Fonts</p>
      <p className="text-[#3C3C3C] text-[17px] leading-relaxed mb-4">
      ...
      <p className="text-[#3C3C3C] text-[17px] leading-relaxed mb-2 font-medium">WP Development in the Modern Stack</p>
      <p className="text-[#3C3C3C] text-[17px] leading-relaxed mb-4">
      ...
      <ul className="list-decimal pl-6 text-[#3C3C3C] space-y-2 mb-6">
