        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start lg:items-stretch">
          ...
          <div className="w-full">
            ...
            <form className="space-y-5 md:space-y-6">
              ...
              <button
                type="submit"
                className="w-full md:w-auto px-8 py-4 bg-primary text-white rounded-full font-medium text-base md:text-lg shadow-[0_14px_30px_rgba(0,0,0,0.16)] hover:shadow-[0_18px_40px_rgba(0,0,0,0.2)] hover:-translate-y-0.5 hover:scale-[1.02] transition-transform transition-shadow duration-300"
              >
                Send now!
              </button>
            </form>
