    ...
    <section className="bg-[#E5E7EB] py-16 md:py-24">
      ...
      >
        ...
        <div className="mt-14 md:mt-16 flex justify-center">
          <Link
            href={ctaHref}
            className="group inline-flex items-center justify-center gap-2 bg-primary text-white rounded-full px-10 py-4 text-[16px] sm:text-[18px] font-medium hover:bg-primary/90 transition-all duration-300"
          >
            {ctaText}
